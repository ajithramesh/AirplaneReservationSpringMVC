...
html, body {
	background-image:
		url('https://onemileatatime.com/wp-content/uploads/2019/10/Qatar-Airways-A350-Business-Class-9.jpg');
				...
				<tbody>
					...
					<c:forEach var="flight" items="${flightList}">
						...
						<tr id='addr0' data-id="0">
							...
							<td>${flight.destLocation }</td>
							<td>${flight.dept_time }</td>
							<td>${flight.dept_time }</td>
							<td>${flight.f_id }</td>
							<td><a
								href='${pageContext.request.contextPath}/downloadETicket?bookingId=${flight.bid}&send=false'
								target="_new">View Ticket</a></td>
							<td><a
								href='${pageContext.request.contextPath}/downloadETicket?bookingId=${flight.bid}'
								target="_new">Email Ticket</a>
							<td><a
								href='${pageContext.request.contextPath}/cancleETicket?bookingId=${flight.bid}'
								target="_new">Cancel Ticket</a> <%-- <a
